 ...
 *   2. Validate { pack_id, consent: true, consent_version }
 *   3. create_pending_top_up RPC: rate limit under a row lock, copies the
 *      pack's credits/price/variant, records Supply Consent. No credits move.
...
export async function POST(req) {
    ...
    return NextResponse.json({ top_up_id: created.top_up_id, checkout_url: checkout.url });
}
