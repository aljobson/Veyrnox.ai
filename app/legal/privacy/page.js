    ...
    return (
        <LegalPage title="Privacy Policy">
            ...
            <ul>
                ...
                <li><strong>Payment data</strong> — credit packs are sold by Veyrnox Ltd, and payments are processed for us by Stripe, Inc. as our data processor. Stripe collects your payment details, billing address and any tax information under its own privacy policy. We receive the payment reference, amount, currency, country and email so we can add the credits to your account and invoice you. We never see or store full card numbers.</li>
            </ul>
