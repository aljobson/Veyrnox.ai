...
export default function CreatorPage() {
  return <main id="main" className="mx-auto max-w-[1100px] px-4 py-10 pb-40 sm:px-8">
    ...
    <p className="mt-4 max-w-2xl text-vx-fg-body">Develop your films and series in private. Video upload is available during the creator preview; review and publishing will follow in a later release.</p>
