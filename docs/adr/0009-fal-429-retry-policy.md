...
- **Status**: Accepted (2026-09-11) — corrected 2026-09-20. It read Proposed while the decision was signed off in this document and the retry policy is in packages/adapters/fal.js.
- **Date**: 2026-09-11
