...
- **Status**: Accepted (2026-09-13), subject to the preconditions below. Decision 2 amended by [ADR-0020](0020-stripe-managed-payments.md) (Stripe Managed Payments); decision 8 amended by [ADR-0019](0019-dispute-webhooks-freeze.md).
- **Date**: 2026-09-13
