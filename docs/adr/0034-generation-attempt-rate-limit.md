...
- Status: Proposed; implementation prepared, production activation requires owner approval of migration 0113.
- Date: 2026-09-24
...
Clip Editor media inspection. Until 0113, that check only counts created jobs.
...
Applying 0113 activates this control for the already-deployed gateway; it is not
