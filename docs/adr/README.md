...
| [ADR-0034 — Generation attempt rate limit](0034-generation-attempt-rate-limit.md) | Proposed 2026-09-24 | Bound pre-debit source work at 20 attempts per account per fixed minute; preserve the ten-job limit and money idempotency. Activates when approved migration 0112 is applied. | Audit finding 06 |
