...
| [ADR-0035 — Upload request rate limit](0035-upload-request-rate-limit.md) | Proposed 2026-09-24 | Bound upload URL issuance to 60 requests per account per minute before R2 work. Staged pending migration 0116 and flag activation. | Audit API rate limits |
