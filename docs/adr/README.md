...
| [ADR-0025 — Media authenticity: provider, or no product](0025-media-authenticity-provider.md) | Proposed 2026-09-18 | fal has no authenticity endpoint at all, a verdict is not an `assets` row, and a confidence score about a named person is a liability the ToS does not cover. Engineering recommends reading C2PA provenance (a fact) over reselling detection (a guess); a detection vendor waits for a named customer. | Track B of the face-filters PRD |
