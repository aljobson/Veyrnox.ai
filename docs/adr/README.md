...
| [ADR-0060 — Nonce CSP rendering](0060-csp-rendering-decision.md) | Proposed 2026-09-25 | Rendering options, current cache baseline and Workers/browser acceptance proof. | #4 |
