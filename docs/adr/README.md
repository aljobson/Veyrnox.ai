...
| [ADR-0040 — Top-up read rate limit](0040-top-up-read-rate-limit.md) | Proposed 2026-09-24 | Share an account quota across Top-up history and status, independently of payment recovery. | Audit API rate limits |
