...
| [ADR-0021 — Generated media moves to the EU-jurisdiction R2 bucket](0021-media-in-eu-jurisdiction-r2.md) | **Accepted 2026-09-13** (cutover pending) | `R2_JURISDICTION=eu` selects the EU S3 endpoint; copy live media, flip the secret, verify, then claim EU storage. Meets ADR-0005 §3 for media. | — |
