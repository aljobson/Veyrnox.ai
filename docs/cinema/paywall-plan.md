...
|---|---|---|---|
| P1 | Publication slice: `PUBLISHED`/`PUBLIC` states on `cinema_content`, moderation gate, public series/episode reads, public feed. Own ADR. | Eng | Nothing is viewable, so nothing is sellable. |
