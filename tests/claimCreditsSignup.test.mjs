...
// "Claim 10 credits" is a sign-up CTA. Linking to bare /app opened the auth
...
for (const file of ['hero.js', 'footer.js']) {
    test(`${file}: Claim 10 credits opens the sign-up form`, () => {
        const src = readFileSync(new URL(`../app/veyrnox/_sections/${file}`, import.meta.url), 'utf8');
        const i = src.indexOf('Claim 10 credits');
